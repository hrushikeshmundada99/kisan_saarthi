        ...
        <div className="flex items-center justify-between h-14 sm:h-16 lg:h-20 gap-2 sm:gap-4">
          ...
          <div className="flex items-center gap-2 sm:gap-3.5">
            ...
            <button
              ...
              className="lg:hidden p-2 rounded-2xl bg-[#F4F9F4] border border-[#D8E6D8] text-[#0F291E] hover:bg-[#E8F5E9] transition-colors cursor-pointer min-h-[40px] min-w-[40px] flex items-center justify-center shadow-xs"
            ...
            >
              ...
              <div className="flex flex-col">
                <span className="text-base sm:text-lg lg:text-xl font-black tracking-tight text-[#0F291E] leading-tight">
                  {t('appName')}
                </span>
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <button
              ...
              className={`relative p-2.5 rounded-2xl border transition-all duration-300 min-h-[40px] min-w-[40px] flex items-center justify-center cursor-pointer shadow-xs ${
            ...
            >
              ...
              {activeAlertsCount > 0 && (
                <span className="absolute top-1.5 right-1.5 w-2.5 h-2.5 rounded-full bg-[#FFB300] ring-2 ring-[#FFFFFF] animate-pulse" />
              )}
            </button>
            ...
            <div data-tour="user-profile" className="shrink-0">
              {isLoggedIn ? (
                <button
                  ...
                  className="flex items-center gap-2 p-1 sm:px-3 sm:py-1.5 rounded-2xl bg-[#F4F9F4] border border-[#D8E6D8] hover:bg-[#E8F5E9] transition-all cursor-pointer shadow-xs min-h-[40px]"
                >
                ...
                <button
                  ...
                  className="px-3.5 py-2 rounded-2xl text-xs font-black bg-gradient-to-r from-[#1B5E20] to-[#2E7D32] text-[#FFFFFF] hover:opacity-95 transition-all flex items-center gap-1.5 cursor-pointer shadow-xs min-h-[40px]"
                >
