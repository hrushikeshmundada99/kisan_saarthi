    ...
    <div className="space-y-6 pb-12 max-w-7xl mx-auto font-sans text-slate-800 animate-in fade-in duration-300">
      ...
      <div className="p-6 bg-white border border-slate-200 rounded-2xl shadow-xs space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3 text-xs">
          ...
          <div className="p-3.5 bg-slate-50 rounded-xl border border-slate-200 space-y-1">
            <span className="text-emerald-800 font-medium">{isMr ? 'प्रक्रिया चॅनेल:' : 'Channel:'}</span>
            <div className="text-xs font-bold text-emerald-900">
              {isMr ? processingLinkage.channelNameMr : processingLinkage.channelNameEn}
            </div>
          </div>

          <div className="p-3.5 bg-emerald-50 rounded-xl border border-emerald-200 space-y-1">
            <span className="text-emerald-800 font-medium">{isMr ? 'निव्वळ अतिरिक्त फायदा:' : 'Net Value Addition:'}</span>
        ...
        <div className="p-3.5 bg-slate-50 border-l-4 border-emerald-600 rounded-r-xl text-xs font-medium text-slate-800 leading-relaxed">
          👉 {isMr ? processingLinkage.recommendedActionMr : processingLinkage.recommendedActionEn}
        </div>
      </div>
