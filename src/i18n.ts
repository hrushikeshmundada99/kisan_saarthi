  ...
  mr: {
    translation: {
      ...
      recommendation: {
        ...
        subtitle: "नेहमीप्रमाणे तेच पिक घेण्याऐवजी, बाजारात ज्या पिकाला सर्वाधिक भाव मिळणार आहे तेच पिक घ्या.",
        calcProfitBtn: "लागवड खर्च व नफा मोजा",
        soilType: "१. जमिनीचा प्रकार (Soil Type):",
        season: "२. हंगाम (Crop Season):",
        waterSupply: "३. पाण्याची उपलब्धता (Water Supply):",
        allSoils: "सर्व जमिनीचे प्रकार (All Soil Types)",
        blackSoil: "काळी जमीन (Deep Black Soil)",
        loamySoil: "मुरमाड / मध्यम जमीन (Medium Loamy Soil)",
        sandySoil: "रेतीली / हलकी जमीन (Sandy Light Soil)",
        allSeasons: "सर्व हंगाम (All Seasons)",
        kharif: "खरीप (Kharif - पावसाळा)",
        rabbi: "रब्बी (Rabbi - हिवाळा)",
        summer: "उन्हाळी (Summer)",
        allWater: "सर्व पाणी पातळी (All Water Levels)",
        lowWater: "कमी पाणी (Low Water Requirement)",
        mediumWater: "मध्यम पाणी (Medium Water)",
        highWater: "भरपूर पाणी (High Irrigation)",
        topRankedBadge: "#1 सर्वाधिक नफा देणारे पिक",
        expectedProfit: "अपेक्षित दर एकरी निव्वळ नफा:",
        perAcre: " / एकर",
        demand: "बाजार मागणी (Demand):",
        climateRisk: "हवामान धोका (Climate Risk):",
        lowRiskText: "कमी धोका",
        days: "दिवस",
        waterReq: "पाणी:",
